...
export default function Contact() {
  ...
  return (
    <section id="contact" className="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 pt-14 pb-8 relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto px-6 relative z-10">
        <motion.div ref={ref} initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}}
          ...
          <div className="inline-flex items-center gap-2 text-slate-300 text-xs mb-12">
            ...
            {links.map((l, i) => (
              <motion.a key={i} href={l.href}
                ...
                <div className="text-left">
                  <p className="text-[10px] text-slate-400 uppercase tracking-widest">{l.label}</p>
